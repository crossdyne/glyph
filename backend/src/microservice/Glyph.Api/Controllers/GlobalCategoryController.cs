...
using Glyph.Application.Features.Categories.Commands.CreateGlobal;
using Glyph.Application.Features.Categories.Commands.DeleteGlobal;
using Glyph.Application.Features.Categories.Commands.UpdateGlobal;
using Glyph.Application.Features.Categories.Queries.GetAllGlobal;
using MediatR;
