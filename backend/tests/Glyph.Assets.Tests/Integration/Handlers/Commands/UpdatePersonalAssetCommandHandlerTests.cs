...
{
    public class UpdatePersonalAssetCommandHandlerTests: IClassFixture<TestFixture>
    {
        private readonly ITestOutputHelper _output;
        private readonly TestFixture _fixture;
        private readonly UpdatePersonalAssetCommandHandler _handler;
        private readonly CancellationToken _cancellationToken = default;

        public UpdatePersonalAssetCommandHandlerTests(TestFixture fixture, ITestOutputHelper output)
        {
            _output = output;
            _fixture = fixture;
            ...
            _handler = new UpdatePersonalAssetCommandHandler(assetRepo, unitOfWork, metadataDetector, fileClient);
        }
        ...
        public async Task Handle_ValidCommandWithFile_UpdatesAssetAndUploadsNewFile()
        {
            ...
            updated.UserId?.Value.Should().Be(userId.Value);
