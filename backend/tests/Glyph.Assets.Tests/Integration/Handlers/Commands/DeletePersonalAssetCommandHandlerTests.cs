...
{
    public class DeletePersonalAssetCommandHandlerTests : IClassFixture<TestFixture>
    {
        private readonly TestFixture _fixture;
        private readonly DeletePersonalAssetCommandHandler _handler;
        private readonly CancellationToken _cancellationToken = default;

        public DeletePersonalAssetCommandHandlerTests(TestFixture fixture)
        {
            _fixture = fixture;
            ...
            _handler = new DeletePersonalAssetCommandHandler(assetRepo, unitOfWork, fileClient);
        }
        ...
        public async Task Handle_ValidCommand_DeletesAssetAndDeletesFile()
        {
            ...
            var command = new DeletePersonalAssetCommand(userId, assetId);
        ...
        {            
            ...
            var command = new DeletePersonalAssetCommand(userId, asset.Id);
            Result result = await _handler.Handle(command, _cancellationToken);
